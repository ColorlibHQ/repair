...
class repair_author_widget extends WP_Widget {
...
'repair_author_widget',


// Widget name will appear in UI
esc_html__( '[ Repair ] Author Widget', 'repair' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'repair' ), )
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'repair' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'designation' ) ); ?>"><?php esc_html_e( 'Designation:' ,'repair'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'repair'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'repair'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'repair'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'repair'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'repair'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'repair' ); ?>:</label>
	<div class="repair-media-container">
		<div class="repair-media-inner">
			...
			<span class="repair-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'repair' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="repair-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'repair' ); ?>" class="button repair-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'repair' ) : __( 'Select Image', 'repair' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button repair-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.repair-media-container {
	width: 98%;
}
...
jQuery(function($){
    ...
    wpshed_image_upload( '.repair-media-upload' );
    ...
    wpshed_image_remove( '.repair-media-remove' );
...
} // Class repair_author_widget ends here


// Register and load the widget
function repair_author_load_widget() {
	register_widget( 'repair_author_widget' );
}
add_action( 'widgets_init', 'repair_author_load_widget' );