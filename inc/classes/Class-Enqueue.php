...
class Repair_Enqueue {

	public $scripts = array();

	public function repair_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'repair_frontend_enqueue_scripts', ) );
	}

	public function repair_frontend_enqueue_scripts( ) {
