 ...
 * @since 1.0
 */
class Repair_Services extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'services_heading',
            [
                'label' => __( 'Services Section Heading', 'repair' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->start_controls_section(
            'style_trainingbox', [
                'label' => __( 'Style Services Content', 'repair' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'color_serviceshovertitle', [
                'label' => __( 'Title Hover Color', 'repair' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => [
