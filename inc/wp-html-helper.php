...
// image default alt
if( ! function_exists( 'repair_img_default_alt' ) ) {
	function repair_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'repair_img_tag' ) ) {
	function repair_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = repair_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'repair_anchor_tag' ) ) {
	function repair_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'repair' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'repair_heading_tag' ) ) {
	function repair_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'repair' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'repair_paragraph_tag' ) ) {
	function repair_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'repair_other_tag' ) ) {
	function repair_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'repair_button_element ' ) ) {
	function repair_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'repair' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
