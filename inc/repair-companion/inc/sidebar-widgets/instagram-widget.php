...
class repair_instagram_widget extends WP_Widget {
...
'repair_instagram_widget',


// Widget name will appear in UI
esc_html__( '[ Repair ] Instagram Widget', 'repair' ),

// Widget description
array( 'description' => esc_html__( 'Add footer instagram widget.', 'repair' ), )
);
...
<ul class="instafeed d-flex flex-wrap">
	...
	foreach( $items as $item ){
		...
		echo '<li><img src="'.esc_url( $imgurl ).'" alt="'.esc_attr( repair_image_alt( $imgurl ) ).'"></li>';
	}
	?>
</ul>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'INSTAFEED', 'repair' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'itemnumber' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'repair'); ?></label>
...
function repair_instagram_load_widget() {
	register_widget( 'repair_instagram_widget' );
}
add_action( 'widgets_init', 'repair_instagram_load_widget' );